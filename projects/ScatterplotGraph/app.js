...
function makeBarChart(dataSet) {
    ...
    console.log("max",d3.max(dataSet,d => d.Time))
    console.log("max",d3.min(dataSet,d => d.Time))

    // Create a x scale
    const xScale = d3.scaleTime()
    .domain([Date.parse(d3.min(dataSet,d => d.Time)),Date.parse(d3.max(dataSet,d => d.Time))])
    ...
    console.log(new Date("39:50"))
    //console.log("max scale",yScale(Dat("39:50")))
